...
describe('PRUEBA DE LA FUNCIONALIDAD DE USUARIOS: HAPPY PATH', () => {
    it('passes', () => {
     ...
     //ESCRIBIR EL USUARIO Y CONTRASEÑA EN EL ACCESO A USUARIOS       
      ...
      cy.get('#Assignment_StartedDate').clear().type('2024-04-04')
      cy.wait(1000)
      ...
      cy.get(':nth-child(1) > .text-muted').should("be.visible").contains("04-04-2024")
      cy.get('.row > :nth-child(2) > .text-muted').should("be.visible").contains("04-04-2024")
