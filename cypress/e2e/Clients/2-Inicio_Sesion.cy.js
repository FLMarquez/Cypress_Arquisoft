...
describe('PRUEBA DE LA FUNCIONALIDAD DE USUARIOS: HAPPY PATH', () => {
    it('passes', () => {
     ...
     //ESCRIBIR EL USUARIO Y CONTRASEÑA EN EL ACCESO A USUARIOS       
      ...
      cy.get(':nth-child(1) > .card > .card-body').should("be.visible").contains("Fecha Completa: 02-04-24")
      cy.get(':nth-child(1) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 02-04-24")
      ...
      cy.get(':nth-child(2) > .card > .card-body').should("be.visible").contains("Fecha Completa: 02-04-24")
      cy.get(':nth-child(2) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 02-04-24")
      ...
      cy.get(':nth-child(3) > .card > .card-body').should("be.visible").contains("Fecha Completa: 02-04-24")
      cy.get(':nth-child(3) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 02-04-24")
      ...
      cy.get(':nth-child(4) > .card > .card-body').should("be.visible").contains("Fecha Completa: 02-04-24")
      cy.get(':nth-child(4) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 02-04-24")
      ...
      cy.get(':nth-child(5) > .card > .card-body').should("be.visible").contains("Fecha Completa: 02-04-24")
      cy.get(':nth-child(5) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 02-04-24")
