...
describe('PRUEBA DE LA FUNCIONALIDAD DE USUARIOS: HAPPY PATH', () => {
    it('passes', () => {
     ...
     //ESCRIBIR EL USUARIO Y CONTRASEÑA EN EL ACCESO A USUARIOS       
      ...
      cy.get(':nth-child(1) > .control-label').should("be.visible").type("32785541")
      //NOMBRE
      ...
      cy.get(':nth-child(2) > .control-label').should("be.visible").type("Federico Lucas")
      //APELLIDO
      ...
      cy.get(':nth-child(3) > .control-label').should("be.visible").type("Marquez")
      //CONTRASEÑA
      ...
      cy.get(':nth-child(4) > .control-label').should("be.visible").type("1234")
      //MAIL
      ...
      cy.get(':nth-child(5) > .control-label').should("be.visible").type("flucas.marquez@hotmail.com.ar")
      //TELEFONO
      ...
      cy.get(':nth-child(6) > .control-label').should("be.visible").type("3512489015")
      //ROL
      cy.get(':nth-child(7) > .control-label').should("be.visible").contains("Rol del Usuario")      
      cy.get('#UserRoleId').should("be.visible").select('Usuario')
