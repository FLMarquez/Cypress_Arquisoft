...
describe('PRUEBA DE LA FUNCIONALIDAD DE USUARIOS: HAPPY PATH', () => {
   ...
   //ESCRIBIR EL USUARIO Y CONTRASEÑA EN EL ACCESO A CLIENTE       
    ...
    cy.get('.btn-primary').should("be.visible").click()
      ...
      cy.get(':nth-child(1) > .card > .card-body').should("be.visible").contains("Compromiso Inicial: 09-04-24")
      cy.get(':nth-child(1) > .card > .card-body').should("be.visible").contains("Compromiso Actual: 16-05-2024")
      cy.get(':nth-child(1) > .card > .card-body').should("be.visible").contains("Fecha Completa: 09-04-24")
      cy.get(':nth-child(1) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 09-04-24")
      ...
      cy.get(':nth-child(2) > .card > .card-body').should("be.visible").contains("Fecha Completa: 09-04-24")
      cy.get(':nth-child(2) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 09-04-24")
      ...
      cy.get(':nth-child(3) > .card > .card-body').should("be.visible").contains("Fecha Completa: 09-04-24")
      cy.get(':nth-child(3) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 09-04-24")
      ...
      cy.get(':nth-child(4) > .card > .card-body').should("be.visible").contains("Fecha Completa: 09-04-24")
      cy.get(':nth-child(4) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 09-04-24")
      ...
      cy.get(':nth-child(5) > .card > .card-body').should("be.visible").contains("Fecha Completa: 09-04-24")
      cy.get(':nth-child(5) > .card > .card-body').should("be.visible").contains("Fecha de Inicio: 09-04-24")
